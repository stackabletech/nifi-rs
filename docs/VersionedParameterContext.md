...
**parameters** | Option<[**Vec<crate::models::VersionedParameter>**](VersionedParameter.md)> | The parameters in the context | [optional]
**inherited_parameter_contexts** | Option<**Vec<String>**> | The names of additional parameter contexts from which to inherit parameters | [optional]
