...
pub async fn delete_connection(configuration: &configuration::Configuration, id: &str, version: Option<&str>, client_id: Option<&str>, disconnected_node_acknowledged: Option<bool>) -> Result<crate::models::ConnectionEntity, Error<DeleteConnectionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/connections/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
...
pub async fn get_connection(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::ConnectionEntity, Error<GetConnectionError>> {
    let local_var_configuration = configuration;
...
pub async fn update_connection(configuration: &configuration::Configuration, id: &str, body: crate::models::ConnectionEntity) -> Result<crate::models::ConnectionEntity, Error<UpdateConnectionError>> {
    let local_var_configuration = configuration;
