...
pub struct ParameterContextValidationRequestEntity {
    ...
    pub request: Option<Box<crate::models::ParameterContextValidationRequestDto>>,
    /// Acknowledges that this node is disconnected to allow for mutable requests to proceed.
    #[serde(rename = "disconnectedNodeAcknowledged", skip_serializing_if = "Option::is_none")]
    pub disconnected_node_acknowledged: Option<bool>,
}

impl ParameterContextValidationRequestEntity {
    pub fn new() -> ParameterContextValidationRequestEntity {
