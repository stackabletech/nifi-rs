...
pub struct CountersDto {
    ...
    pub aggregate_snapshot: Option<Box<crate::models::CountersSnapshotDto>>,
    ...
    pub node_snapshots: Option<Vec<crate::models::NodeCountersSnapshotDto>>,
}

impl CountersDto {
    pub fn new() -> CountersDto {
        CountersDto {
