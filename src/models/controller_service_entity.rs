...
pub struct ControllerServiceEntity {
    ...
    pub component: Option<Box<crate::models::ControllerServiceDto>>,
    ...
    pub status: Option<Box<crate::models::ControllerServiceStatusDto>>,
}

impl ControllerServiceEntity {
    pub fn new() -> ControllerServiceEntity {
