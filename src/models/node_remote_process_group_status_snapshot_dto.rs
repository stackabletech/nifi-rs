...
pub struct NodeRemoteProcessGroupStatusSnapshotDto {
    ...
    pub status_snapshot: Option<Box<crate::models::RemoteProcessGroupStatusSnapshotDto>>,
}

impl NodeRemoteProcessGroupStatusSnapshotDto {
    pub fn new() -> NodeRemoteProcessGroupStatusSnapshotDto {
