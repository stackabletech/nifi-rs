...
pub struct ProcessorDiagnosticsEntity {
    ...
    pub component: Option<Box<crate::models::ProcessorDiagnosticsDto>>,
}

impl ProcessorDiagnosticsEntity {
    pub fn new() -> ProcessorDiagnosticsEntity {
