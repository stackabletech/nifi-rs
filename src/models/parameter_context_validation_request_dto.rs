...
pub struct ParameterContextValidationRequestDto {
    ...
    pub update_steps: Option<Vec<crate::models::ParameterContextValidationStepDto>>,
    #[serde(rename = "parameterContext", skip_serializing_if = "Option::is_none")]
    pub parameter_context: Option<Box<crate::models::ParameterContextDto>>,
    #[serde(rename = "componentValidationResults", skip_serializing_if = "Option::is_none")]
    pub component_validation_results: Option<Box<crate::models::ComponentValidationResultsEntity>>,
}

impl ParameterContextValidationRequestDto {
    pub fn new() -> ParameterContextValidationRequestDto {
        ParameterContextValidationRequestDto {
            ...
            component_validation_results: None,
        }
    }
}
