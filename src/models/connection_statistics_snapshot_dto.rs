...
pub struct ConnectionStatisticsSnapshotDto {
    ...
    #[serde(rename = "predictionIntervalMillis", skip_serializing_if = "Option::is_none")]
    pub prediction_interval_millis: Option<i64>,
}

impl ConnectionStatisticsSnapshotDto {
    pub fn new() -> ConnectionStatisticsSnapshotDto {
        ConnectionStatisticsSnapshotDto {
            ...
            prediction_interval_millis: None,
        }
    }
}
