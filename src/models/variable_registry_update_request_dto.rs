...
pub struct VariableRegistryUpdateRequestDto {
    ...
    pub update_steps: Option<Vec<crate::models::VariableRegistryUpdateStepDto>>,
...
impl VariableRegistryUpdateRequestDto {
    pub fn new() -> VariableRegistryUpdateRequestDto {
