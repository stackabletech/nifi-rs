...
pub struct ControllerServiceReferencingComponentEntity {
    ...
    pub component: Option<Box<crate::models::ControllerServiceReferencingComponentDto>>,
...
impl ControllerServiceReferencingComponentEntity {
    pub fn new() -> ControllerServiceReferencingComponentEntity {
