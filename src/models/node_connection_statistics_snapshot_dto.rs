...
pub struct NodeConnectionStatisticsSnapshotDto {
    ...
    #[serde(rename = "statisticsSnapshot", skip_serializing_if = "Option::is_none")]
    pub statistics_snapshot: Option<Box<crate::models::ConnectionStatisticsSnapshotDto>>,
}

impl NodeConnectionStatisticsSnapshotDto {
    pub fn new() -> NodeConnectionStatisticsSnapshotDto {
