...
pub struct RemoteProcessGroupEntity {
    ...
    pub component: Option<Box<crate::models::RemoteProcessGroupDto>>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<crate::models::RemoteProcessGroupStatusDto>>,
...
impl RemoteProcessGroupEntity {
    pub fn new() -> RemoteProcessGroupEntity {
