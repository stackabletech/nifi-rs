...
pub struct ComponentValidationResultsEntity {
    ...
    pub validation_results: Option<Vec<crate::models::ComponentValidationResultEntity>>,
}

impl ComponentValidationResultsEntity {
    pub fn new() -> ComponentValidationResultsEntity {
