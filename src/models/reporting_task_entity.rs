...
pub struct ReportingTaskEntity {
    ...
    pub component: Option<Box<crate::models::ReportingTaskDto>>,
    ...
    pub status: Option<Box<crate::models::ReportingTaskStatusDto>>,
}

impl ReportingTaskEntity {
    pub fn new() -> ReportingTaskEntity {
        ReportingTaskEntity {
            revision: None,
            id: None,
            uri: None,
