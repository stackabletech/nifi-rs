...
pub struct LocalQueuePartitionDto {
    ...
    #[serde(rename = "allActiveQueueFlowFilesPenalized", skip_serializing_if = "Option::is_none")]
    pub all_active_queue_flow_files_penalized: Option<bool>,
    /// Whether or not any of the FlowFiles in the Active Queue are penalized
    #[serde(rename = "anyActiveQueueFlowFilesPenalized", skip_serializing_if = "Option::is_none")]
    pub any_active_queue_flow_files_penalized: Option<bool>,
}

impl LocalQueuePartitionDto {
    pub fn new() -> LocalQueuePartitionDto {
        LocalQueuePartitionDto {
            ...
            all_active_queue_flow_files_penalized: None,
            any_active_queue_flow_files_penalized: None,
        }
    }
}
