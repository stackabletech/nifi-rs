...
pub struct RemoteProcessGroupPortEntity {
    ...
    #[serde(rename = "remoteProcessGroupPort", skip_serializing_if = "Option::is_none")]
    pub remote_process_group_port: Option<Box<crate::models::RemoteProcessGroupPortDto>>,
...
impl RemoteProcessGroupPortEntity {
    pub fn new() -> RemoteProcessGroupPortEntity {
        RemoteProcessGroupPortEntity {
            ...
            remote_process_group_port: None,
