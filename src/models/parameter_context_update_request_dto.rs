...
pub struct ParameterContextUpdateRequestDto {
    ...
    pub update_steps: Option<Vec<crate::models::ParameterContextUpdateStepDto>>,
...
impl ParameterContextUpdateRequestDto {
    pub fn new() -> ParameterContextUpdateRequestDto {
